...
**\n"
    ...
    def _get__inp_material(self):
        ...
        """
        material = '// Shell and Beam Material definition\n\n\n'
        material += 'MATERIAL ID 1\n'
        material += '  NAME "Solid:wb_shell_mat#1#1"\n'
        material += '  TYPE\n'
        material += '   "CC3DNonLinCementitious2"\n'
        material += '// For base is used my_concrete\n'
        material += '  E     4.524080e+04\n'
        material += '  MU     2.000000e-01\n'
        material += '  RHO     2.300000e-03\n'
        material += '  ALPHA     1.200000e-05\n'
        material += '  FT     4.950000e+00\n'
        material += '  FC    -9.320000e+01\n'
        material += '  GF     1.650000e-04\n'
        material += '  WD    -5.000000e-04\n'
        material += '  EXC     5.100000e-01\n'
        material += '  BETA     0.000000e+00\n'
        material += '  FC0    -1.040000e+01\n'
        material += '  EPS_CP    -8.720000e-04\n'
        material += '  FIXED     1.000000e+00\n'
        material += '  FC_REDUCTION     8.000000e-01\n'
        material += '  AGG_SIZE     2.000000e-02\n'
        material += '\n\n\n\n'
        return material
    ...
    def _get__inp_step_header(self):
        step_header = '// ----------------------------------------------------------------\n'
        step_header = '// ATENA Input file. Generated by bmcs_shell Python project \n'
        step_header = '// ----------------------------------------------------------------\n'
        step_header = 'MODULE TYPE "CCStructures" CHECK\n'
        step_header = 'TASK name "shell_analysis"\n\n\n'
        step_header = 'Title "Static analysis"\n'
        step_header = ' dimension  3\n\n\n'
        step_header = 'UNITS // using in GiD and Atena\n'
        step_header = '  force        "MN"\n'
        step_header = '  length       "m"\n'
        step_header = '  temperature  "C"\n'
        step_header = '  time         "sec"\n'
        step_header = '  mass         "kton"\n\n\n\n'
        return step_header
